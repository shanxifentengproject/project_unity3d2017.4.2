...
class SceneControlRootPackage1 : SceneControl
{
    ...
    public UniGameBootFace gameBootFace = null;
    ...
    {
        VirusGloableData.Instance.m_VirusData.IsLoadingRootScene = true;
    ...
    {
        ////用户昵称产品示范
        //UniNameCreate nameCreate = new UniNameCreate();
        //int index = nameCreate.RandomName(-1);
        //string name = nameCreate.GetName(index);
